  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col-reverse space-y-10 items-center justify-center mx-10 md:flex-row md:space-x-24 md:space-y-0 md:p-4">
        ...
        >
          <h2 className="my-4">Ingin Buat Portofolio?</h2>
          <h2>Website kami solusinya!</h2>
          <h2>
            Website ini merupakan platform yang cocok digunakan dalam membuat portofolio
          </h2>
            <a href="mailto:ruditabudi1945@gmail.com">
      ...
      <h4 className="text-center pt-12 md:inline text-md md:border-l-8 border-dark dark:border-light md:px-4 md:py-2 p-12 font-bold dark:text-light text-dark">
        Kamu dapat menghubungi kami melalui media sosial dibawah ini, jika terjadi masalah pada email.
      </h4>
